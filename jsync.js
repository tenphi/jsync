...
(function() {
  var chokidar, clearObject, coffee, containsArray, evalCoffee, evalJS, extend, fs, getFilePath, getWatcher, handleObject, isCoffeeFile, isStored, js2coffee, jsync, listObjects, listWatchers, removeObject, sourin, storeObject, targ;
  ...
  jsync.save = function(obj, file, handler) {
    var filePath, min, src, _ref;
    _ref = targ(arguments, {
      obj: Object,
      file: String,
      min: Boolean,
      handler: Function
    }), obj = _ref.obj, file = _ref.file, min = _ref.min, handler = _ref.handler;
    if (!file) {
      throw 'file not set';
    }
    filePath = getFilePath(file);
    ...
    return fs.writeFileSync(filePath, src, 'utf-8');
  };
